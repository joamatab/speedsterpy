...
class TestUtil(unittest.TestCase):
    ...
    def test_gds_table_write(self):
        path = (
            "/Users/dasdias/Documents/SoftwareProjects/speedsterpy/spdstrutil/resources"
        )
        gdsTab = GdsTable()
        gdsTab.add(
            layer=71,
    ...
    def test_filter_gds_table_by_purpose(self):
        ...
        # print(str(newtab))
        self.assertEqual(newTab.getLayerName(71, 20), "met4")  # met4, drawing, text
        self.assertEqual(
            newTab.getLayerPurpose(71, 20),  # met4, drawing, text
            [GdsLayerPurpose.DRAWING, GdsLayerPurpose.TEXT],
        )
        self.assertIsNone(newTab.getGdsTableEntriesFromPurpose(GdsLayerPurpose.BLOCK))
    ...
    def test_filter_gds_table_by_layer_name(self):
        ...
        # print(str(newtab))
        self.assertEqual(newtab.getLayerName(71, 20), "met4")  # met4, drawing, text
        self.assertIsNone(newtab.getGdsTableEntriesFromLayerName("met5"))

    def test_get_gds_layer_datatype_from_layer_name_purpose(self):
        path = "/Users/dasdias/Documents/SoftwareProjects/speedsterpy/resources/sky130/skywater-pdk-libs-sky130_fd_pr/skywater130/gds_layers.csv"
        gdsTab = readGdsTable(path)
        # print(str(gdsTab))
        layerDatatype = gdsTab.getGdsLayerDatatypeFromLayerNamePurpose(
            "met4", GdsLayerPurpose.NET
        )
        self.assertIn((71, 23), layerDatatype)

    def test_get_metal_drawing_layers(self):
        path = "/Users/dasdias/Documents/SoftwareProjects/speedsterpy/resources/sky130/skywater-pdk-libs-sky130_fd_pr/skywater130/gds_layers.csv"
        gdsTab = readGdsTable(path)
        layerMap = gdsTab.getDrawingMetalLayersMap()
        self.assertEqual(layerMap["met4"], (71, 20))
        self.assertEqual(layerMap["via3"], (70, 44))
        self.assertIsNone(layerMap.get("pad"))
        self.assertIsNone(layerMap.get("mcon"))
    ...
    def test_add_backannotation(self):
        ...
        self.assertEqual(
            gdsTab.getGdsLayerDatatypeFromLayerNamePurpose(
                "met4", GdsLayerPurpose.BACKANNOTATION
            )[0],
            (71, 26),
        )
        self.assertIsNone(
            gdsTab.getGdsLayerDatatypeFromLayerNamePurpose(
                "mcon", GdsLayerPurpose.BACKANNOTATION
            )
        )
    ...
    def test_add_highlightnet(self):
        ...
        self.assertIsNone(
            gdsTab.getGdsLayerDatatypeFromLayerNamePurpose(
                "mcon", GdsLayerPurpose.HIGHLIGHTING
            )
        )
