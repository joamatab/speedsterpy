...
SYSTOKENS = [
    (
        "lib",
        "library",
        "create a new project library library associated with a given technology",
    ),
...
SYSARGS = {
    "lib": [
        ...
        (
            ...
            "<dirpath>",
            str,
        ),  # to save images and other output files
        ...
        (
            "-net",
            "circuit (SPICE) netlists file path to extract netlist info",
            "<filepath>",
            str,
        ),
    ...
    "rpex": [
        (
            "-ptp",
            "perform point-to-point resistance extraction, producing a .spr file",
            "<>",
            None,
        ),
        ...
        (
            "-b",
            "produce a .toml file with the consumed time and memory computing resources benchmarks of the extraction",
            "<>",
            None,
        ),
        ...
        (
            "-net",
            "generate a netlist file with a given netName from extracted data",
            "<filepath>",
            str,
        ),
        (
            "-o",
            "produces .yaml files with the resulting structures from parasitic extraction",
            "<>",
            None,
        ),
    ],
